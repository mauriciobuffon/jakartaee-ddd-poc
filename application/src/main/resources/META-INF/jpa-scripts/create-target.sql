...
create table Entidade (id bigint not null, dado varchar(255) not null, version timestamp not null, agregador_id char(16) for bit data not null, primary key (agregador_id, id));
